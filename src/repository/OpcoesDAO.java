...
public class OpcoesDAO {
    ...
    public static Opcoes consultarOpcao(Integer id) throws SQLException {
        Connection conn = repository.Mysql.getConnection();
        String sql = "select * from opcoes where  id_opcoes = ?";
    ...
    public static void main(String[] args) throws SQLException {
        ...
        try {
            System.out.println(todasOpcoes(1));
